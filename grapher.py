...
class Statistics(general.Manager):
    ...
    def __init__(self,
        ...
        self.category_scatter_dic = None
        # pca_analysis()
        self.pca_dic = None
        # pca_loadings()
    ...
    # 散点分类绘图
    def category_scatter_analysis(self, data_dic: Optional[dict] = None, save_path: Union[bool, str] = True,
        ...
        :return result_dic: (dict)，键为 title，值为绘图所用 DataFrame，仅 3 列，为 X、 Y 与 Statistics.Category_Index 列
        ...
        title, data_df = list(data_dic.items())[0]
        ...
        if show_result:
            ...
            # 也可打印各类别样本数等
            print(f"Categories: {unique_category}, Counts: {[(category_index == c).sum() for c in unique_category]}\n")

        result_dic = {title: plot_df}
        self.category_scatter_dic = result_dic  # 可存储到实例属性，便于后续使用
